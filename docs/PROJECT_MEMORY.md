...
> ## 🟢 P6 TAMAMLANDI — P7 YÜRÜTÜLÜYOR (batch içinde, durmadan)
>
> **P2 ✅ · P3 ✅ · P4 🟡 · P5 ✅ · P6 ✅** — dal `phase/6-customer-system`.
>
> Kullanıcı 2026-08-15 tarihli yönergesiyle P5→P7 batch'ini onayladı ve fazlar
> arasında onay beklenmemesini istedi. P6 kapandı; **P7 (Navigasyon ve
> Pathfinding) doğrudan başlatıldı.**
>
> **Batch bittiğinde durulacak nokta:** P7 sonu. P8–P10 yetkisiz.
>
> **P6'dan taşınan açık maddeler** (hiçbiri P7'yi engellemiyor):
>
> - Dönüşüm anı yargısı — üretim sanatı gerektiriyor, sanat sonrası ilk fazda
> - Fren lambaları aktör-karelerinin %33'ünde yanıyor; anlamını yitirecek kadar
>   çok olabilir → P12 trafik yoğunluğu dengelemesi
> - `globalDifficultyCurve`'ün clamp'a göre yeri: GDD §9.5 ile roadmap/ECONOMY
>   §7 farklı yazıyor. Eğri 1.0 olduğu sürece üç okuma da sayısal olarak aynı,
>   bu yüzden P6'da hiçbir şey buna bağlı değil → P12
> - `menuAppeal` (P8), `priceFit` (P9), `weatherFactor` (P15) hâlâ literal 1.0
