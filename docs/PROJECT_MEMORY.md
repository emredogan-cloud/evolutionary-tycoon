...
| **Mevcut kapı**    | Kullanıcı 2026-08-21/22 konsolidasyon yönergesi: şube birleştirme + premium UI + oynanış onarımı, sonunda DUR |
...
## DEPENDENCY CHANGE #2 — @axe-core/playwright

Eski: yok
Önerilen: 4.10.2 (tam pin)
Sınıf: APPROVED-FEATURE
Gerekçe: Roadmap P18 "axe-core tüm ana ekranlarda; kritik/ciddi ihlal build'i kırar" — CI'daki a11y kapısının aracı.
Kanıt: GAME_EXECUTION_ROADMAP §P18 Testing; tests/e2e/a11y.spec.ts 6 ekranda koşuyor, iki gerçek ihlali (adsız progressbar ×2, odaklanamaz kaydırma bölgesi) yakalayıp düzelttirdi.
Uyumluluk: devDependency; playwright peer'ı mevcut 1.62 ile uyumlu; üretim bundle'ına girmez.
Testler: pnpm e2e (a11y.spec), pnpm verify.
Onay: batch yetkisi (P18 kapsamı roadmap'te axe'i adıyla zorunlu kılar) — 2026-08-21.
...
| #          | Ölçüt                                      | Durum                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| ---------- | ------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-08-22 | **AT**                                     | **KONSOLİDASYON MAIN'DE VE ÜRETİMDE.** PR #19 squash `0ba8bbe` (16/16 kontrol, CLEAN); dal koşuları `249c311/5477619`: CI 32542769699 + Preview E2E 32543039178 yeşil. Main dispatch CI **32544214010 YEŞİL**; main deployment Preview E2E 32544391849 yeşil; **Production smoke 32544391996 YEŞİL — projenin İLK gerçek üretim smoke koşusu** (üretim 3d3b036/şema 5'ten 0ba8bbe/şema 11'e atladı). Canlı üretim ölçümleri: health `0ba8bbe…` birebir; yol asset'i 200/1.63 MB; CDN soğuk 16.5 sn/8.85 MB tel (SW kuruldu; rezerv atlası ready sonrası akar), sıcak 1.8 sn/~0 ağ; canlı 5 dk oynayış {tick 6716, frames 8641, droppedTicks 0, pageErrors []}. Çalışma ağacı temiz. **P19+ YETKİSİZ — DURULDU.**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| 2026-08-22 | **AP**                                     | **Teslimat sindirimi + arayüz yeniden doğuşu.** 127 dış-üretim asset gerçek boru hattından: 279 kaynak/0 hata/75 kayıtlı istisna; matris **289 PRESENT+VERIFIED, görsel borç SIFIR**; DIRECTION_AUDIT v2 (arka boşluklar gerçek sanatla kapandı, kurallar default-varyanta daraltıldı); §1.4 bölme kuralı yürünen-alan nesnelerine kapsamlandı ve §13 satırları teslim edilen sete boyutlandı (ikisi de kayıtlı değişiklik); **deferred yükleme katmanı** kritik yolu 3.58/4.00 MB'ta tuttu. Referans denetimi (3 görsel, piksel piksel) → tam ekran premium HUD: ekonomi/zaman hapları, nav+aksiyon karoları, hız rayı, 30 kartlık aile-gruplu yapı paneli (kilit sebepleri açık; '+' modeli SİLİNDİ), merkezli yükseltme detayı, hedef listesi kartı, sipariş kartları; debug her build'de yalnız `?debug=1`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| 2026-08-22 | **AQ**                                     | **Oynanış onarımı + dünya davranışları.** KÖK NEDEN: UI'da hazırlama fiili hiç yoktu (`UiCommands`'ta prep yok; MANUAL_PREP yalnız fixture'lardaydı) → sipariş kartları + `prep()` intenti; tarayıcı kanıtı **0.00 → 3.72** gerçek Hazırla düğmesiyle. Park süpürme-geçişi manevra geometrisinde çözüldü (1.6 m koridor; drive-thru sırası tasarımca hat üstünde). ON arketip canlı (%8 rezerv; orijinaller %92 oran-sabit; balance yeşil), fren kareleri, batı yüzleri çizim-anı aynası (sıfır bayt; anchor da aynalanır). Aşama-3 masa servisi `tableService.spec` ile uçtan uca: masada geometrik oturma + eller-serbest garson servisi. 13. pin yenilemesi gerekçeli.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| 2026-08-22 | **AR**                                     | **Progresyon + evrim.** Türetilmiş oyuncu seviyesi (hash'li sayaçların saf fonksiyonu — yeni state yok, şema kımıldamadı; `levelGate` testleri), 12 vitrin seviye-kapısı balance kapısıyla bağlamadığı KANITLI; `PROGRESSION_DESIGN.md` config'ten üretilmiş tam envanterle (30 kademe/13 menü/roller/3 geçiş) + ölçülmüş pacing (1–2 günde bitmez: S4 hem saatler derinliğinde hem yol kararına kilitli). Evrim zinciri senaryo F ile yeşil; `STAGE_CHANGED` şeridi artık açılanı adlandırıyor.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| 2026-08-22 | **AS**                                     | **Konsolidasyon doğrulama bataryası.** `pnpm verify` exit 0 uçtan uca: 1548 unit+integration, determinizm 61/61, balance 5/5 (assert'li aşama satırları on-arketipli karışımla yeşil), bench 22/22, kapsam yeni testlerle her eşiğin üstünde (hiçbiri indirilmedi — atlasIcons/fren çözücü/sipariş beslemesi/seviye kenarları eklendi). Chromium E2E 99 (yeni `tableService` dahil); 19 dünya goldeni konteynerde yenilendi ve **her biri göz'le kabul edildi** (etek+tek-band vinyet+filo+koridor+fren kareleri); konteyner doğrulama ×2 + host bayt-özdeş; çerçeve pini 241 gerekçeli.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| 2026-08-21 | **AO**                                     | **KONSOLİDASYON: P8–P18 main'e indi (PR #18, squash `6237a64`).** Kullanıcı yönergesi: P19 öncesi ürün konsolidasyon pasosu (UI/UX + oynanış onarımı; yeni faz DEĞİL). Birleşme öncesi main `3d3b036` (Phase 7, 2026-08-15'ten beri kımıldamamış). Ata-lık kanıtla doğrulandı: phase/{8-service-loop 62561c3, 11-evolution a63928c, 14-offline 26d4587, 15-events-weather 7ea73ab, 16-asset-v2 c6a827f, 17-anim-vfx-audio 77d6566, consolidation-art 4394acf} hepsi 18 ucunun atası; sapan iki şube (fix/depth-sort-bench-precision, phase/04-licence-override) zaten #14/#12 squash'larıyla main'de — içerik kapsandı; dependabot şubeleri bilinçli dışarıda (bağımlılık disiplini). Kör merge yapılmadı: `git merge-base --is-ancestor` + tek-ebeveyn kanıtıyla squash geleneği izlendi. PR-diff CodeQL 2 gerçek bulgu yakaladı ve kökten düzeltildi (`1c1deba`): testHooks.deepMerge **proto**/constructor/prototype anahtarlarını reddediyor (tamper yaması tanımı gereği saldırgan-şekilli), fourProperties.test stat-sonra-oku yarışı Dirent'li readdir ile tek sistem çağrısına indi. PR #17 (Phase 8) kapsandığı için kapatıldı. PR kontrolleri: 16/16 yeşil (CodeQL dahil), merge state CLEAN. Ana dal CI'ı `6237a64`te dispatch edildi (run 32515954664); main push'u İLK GERÇEK ÜRETİM dağıtımını tetikleyecek (prod `3d3b036`/schema 5 → schema 11) — production smoke ilk kez gerçek koşacak. Yeni kullanıcı girdileri: 3 UI referans PNG'si (docs/assets) + docs/assets/sources'a **127 üretilmiş asset** (P177–P303; P173–176 teslimatta yok — mutabakat import'ta). Çalışma dalı: `phase/consolidation-ui`. Yönergenin checkpoint harfi AN idi; AN bu dosyada P17–P18 kapanışına ait olduğundan bu pas AO'dan başlar. |
...
| **Sanat borcu (tek kaynak)** | 🟠 `docs/FINAL_ASSET_REQUIREMENTS.md` + makine ikizi `assetRequirements.json` — **300 satır**: 158 PRESENT+VERIFIED · 116 MISSING+PROMPT ADDED · 15 PRESENT+NEEDS REGEN · 9 PROCEDURAL · 1 NOT REQUIRED · 1 DEBUG ONLY. Kapsama kapısı build-kıran. **2026-08-22: 289 PRESENT+VERIFIED — görsel borç SIFIR** (127 teslimat sindirildi; 279 kaynak/0 hata/75 kayıtlı istisna). Kalan dış girdi: **23 ses dosyası** (`AUDIO_ASSET_REQUIREMENTS.md`, sahte ses yok) + **1 OFL disleksi fontu**. |
...
> ## 🔴 DUR — UI/WORLD DÜZELTME PASOSU TAMAMLANDI. KULLANICI İNCELEMESİ BEKLENİYOR. P19+ YETKİSİZ.
>
> 2026-08-22 (ikinci yönerge): hedefli UI/dünya düzeltme pasosu, `fix/ui-world-correction`
> dalında. Dokuz madde kök nedenden çözüldü, tamamı tarayıcı kanıtlı (seed 424242):
>
> 1. **Dünya doluluğu** — zemin bake'i kameranın erişebileceği TÜM dikdörtgene ayna-döşeme
>    (min zoom 0.6'da 3840×2160'ı kapsar); gece/yağmur/vinyet katmanları her karede kameranın
>    görünür dünya dikdörtgenine oturtuldu (scrollFactor-0 zoom tuzağı üç yerde kapatıldı).
> 2. **Yol** — teslim edilen dilim kendi içine kapalı diyorama; yol artık kilitli paletten
>    dünya-uzayında SÜREKLİ bant (banket+bordür+sarı çizgi+kesikli orta+drenaj+aşınma).
>    Dikişsiz şerit asset'i P304 olarak promptlandı.
> 3. **Park** — işaretli layby (çizili kutu+takoz+ayrılmış yaya ağzı); araçlar taşıt yolundan
>    tamamen dışarıda park eder; uzunluk-farkındalıklı yuva ataması (11 m otobüs komşu
>    yuvaları da kaplar — üstüne değil). Dört aşamada flood-fill probu ile doğrulandı.
> 4. **Araç görünümü** — 9 adet 2026-08-21 teslimi yanlış yön gösteriyor (tam boy yeşil-zemin
>    okumasıyla kanıtlı); `VEHICLE_FACING_FIXES` çalışma anında doğru arka görünümleri
>    kullanıyor; NEW_VEHICLE_01–09 regen promptları eklendi. Park hâlinde bayat fren durumu
>    düzeltildi. 10-araç deterministik çakışmasız test eklendi.
> 5. **Tezgah** — tente zemin yerine tezgâhın üzerine (z 1.75) monte edildi.
> 6. **Karakterler** — 1.8× zoom'da siluetler tutarlı; "bacak" dosyaları hâlâ kol
>    (NEW_CHARACTER_01–08 regen promptları; UNUSED_RIG_SUBJECTS korunuyor).
> 7. **İnşa görünürlüğü** — kök neden: `world.layout.placed` render'a HİÇ bağlanmamıştı +
>    buildable'lar placeholder stem'leri adresliyordu. SimView'e placed/pending satırları,
>    gerçek obje id'leri, v12 şema migrasyonu.
> 8. **Zamanlı inşaat** — satın alma → şantiye (silüet+ilerleme çubuğu) → sim-zamanlı geri
>    sayım → tamamlanınca etki+obje+event birlikte. `buildDurationMs(cost)` 6–24 oyun-dk;
>    duraklat/2×/4×/reload/offline tarayıcıda kanıtlı. Balance gate 5/5 yeşil.
> 9. **Prompt kataloğu** — 308 prompt (303+5), 22/22 kapsama, 0 kayıp/çift/yetim.
>
> Kanıt: §22 AU→BC · UI_WORLD_CORRECTION_REPORT.md · BUILD_CONSTRUCTION_DESIGN.md ·
> goldenlar konteynerde yenilendi ve göz'den geçti (24/24) · 1560+ test · determinizm 61/61.
>
> ### Kullanıcının önündeki kararlar (değişmedi)
>
> 1. 🔴 **Yol/arsa yapısı** — S4 kapasite bloğu; menü kalibrasyon raporu §4. **Bu pasoda
>    genişledi:** erken-aşama karşı-şerit geçiş disiplini denendi ve ÖLÇÜLDÜ (yol çöküyor:
>    13.9→3.1 m/s); geçiş transienti bu kararın parçası olarak dosyalandı.
> 2. 🔴 **GDD §8 ⊗ §6.1** — S2 `CALIBRATED_STAGES` üyeliğini tutuyor.
> 3. 🟠 **S7 i18n** — öneri dosyalı, karar bekliyor.
> 4. 🟠 **Perf yedeği 5→8 ms** — CHANGE REQUEST duruyor.
> 5. 🟠 **Dış üretim:** 23 ses + 1 OFL font + **bu pasonun 22 görsel kalemi**
>    (17 regen + 5 yeni; FINAL_ASSET_REQUIREMENTS güncel).
>
> ### Şimdi ne yapılıyor
>
> **HİÇBİR ŞEY.** Kullanıcı incelemesi bekleniyor; P19 dahil hiçbir faz yetkili değil.

## 22. Change Log

| Tarih      | Checkpoint | Değişiklik                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| ---------- | ---------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-08-21 | **AN**     | **BATCH P17–P18 KAPANDI.** P18 CI kırmızısı (e8a0b25, run 32461797407) üç kökte çözüldü, hiçbir eşik gevşetilmedi: (1) staffFlow'un dock öncesi beş `staff-toggle` tıklaması paneli kapatıyordu → spec oyuncunun yolunu yürüyor; StaffPanel dock'un altına giriyordu → offset+z-index (gerçek ürün hatası). (2) a11y pause testi Space'e basıyordu → HUD listener yarışı; test SET_PAUSED komut kapısından geçiyor. (3) Panel golden'ları CI'da SIFIR tamamlanmış karşılaştırmayla zaman aşımıydı (piksel farkı değil): yarı saydam panel arkasındaki canlı WebGL kanvası SwiftShader'da kompozit anına yetişemiyor → `capture.css` yakalama sırasında kanvası gizler (düz token zemini; aynı saydamlık/blur/radius korunur), goldenlar konteynerde yeniden üretildi (digest `dcc5531e` CI ile birebir doğrulandı), iki doğrulama koşusu stabil, dünya golden'ları bayta kadar değişmedi. Yerel firefox e2e bu host'ta koşamaz (xvfb-run yok, GL bağlamı açılmıyor — ölçüldü; CI konteyneri xvfb ile koşar, ci.yml:267). Bellek bakımı: §1/§2/§5/§6/§10/§15/§16/§17/§18/§21 batch-sonu gerçeğine getirildi (birkaç batch'tir bayat kalan durum katmanı düzeltildi). SON KOD SHA `d0cbae4`: CI **32467140143 YEŞİL** (8 dk 45 sn) + Preview E2E **32467368549 YEŞİL** (5 dk 59 sn); e8a0b25 kırmızıları aynı işlerin önceki koşularıydı. EK (addendum): dokümantasyon SHA'sı `5652f4a` de kendi koşularıyla yeşil — CI **32469364343** (9 dk 7 sn) + Preview E2E **32469594005** (5 dk 25 sn). Deployment: önizleme `jj7uchzwj` health `d0cbae42…` birebir/schema 11; yol 200/1.63 MB; CDN soğuk 10.0 sn/5.53 MB tel (SW kuruldu), sıcak 1.6 sn/~0 ağ baytı; canlı 5 dk oynayış {tick 6112, hava 1, droppedTicks 0, pageErrors []}. Production (main) `3d3b036`/schema 5 — batch main'e değmedi, şube modeli. **P19+ YETKİSİZ — DURULDU.**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
| 2026-08-22 | **AU**     | **UI/world düzeltme pasosu başladı.** Kullanıcının 6 ekran görüntüsü (`assets/`) temel durum; dokuz maddelik yönerge. Dal `fix/ui-world-correction`. Tarayıcı temeli: 5174'te taze dev sunucu (kullanıcının 5173'ü 504'e takılı — dokunulmadı); boşluk/dikiş/tente/park sorunları canlı yeniden üretildi.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| 2026-08-22 | **AV**     | **Viewport/dünya doluluğu.** Kök nedenler: lot-dikdörtgeni bake + Phaser 4'te sessizce çalışmayan geometry mask + düz renk etek; scrollFactor-0 viewport quadları zoom'da küçülüyor (kullanıcının 6. görüntüsündeki sert kenarlı karanlık dikdörtgenler). Çözüm: `groundCoverRect` (min zoom'da 3840×2160 kapsar) üzerinde ayna-döşeme + deterministik ton yıkamaları; gece/ıslak/yağış/vinyet her karede görünür dünya dikdörtgenine oturur. Kanıt: zoom 0.6/1.0/1.8 ekran görüntüleri, tam kaplama; gece perdesi tam kare. Commit `605a4ab`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| 2026-08-22 | **AW**     | **Yol + park.** Teslim yol dilimi kendi uçlarına sarılı diyorama → bantlar diyagonal merdiven (kullanıcı görüntüleriyle bire bir). Yol artık paletten sürekli dünya-uzayı kompozisyonu (banket, bordür taş dikişleri, sarı kenar, kesikli orta, aşınma bantları, drenaj); P304 dikişsiz şerit promptu. Park: işaretli layby (5×2.6 m kutular, takoz, taşıt yolu klempi), yuva çiftleri tezgâhın iki yanında; yaya ağzı bordür düşürülmüş. Derin sıralar kendi asfalt pedlerinde. Dört aşamada flood-probe `intact=true`. `stageLayouts` testi 4 m hatamı yakaladı → 2.5/7.5/16.5/21.5.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| 2026-08-22 | **AX**     | **Araç görünüşü/hareketi.** Atlas kare-kare tam boyda yeşil üstünde okundu: 9 dosya adının vaadettiği yönü göstermiyor (sedan_n, pickup_n/ne/nw, van_n/ne/nw, motosiklet_n önden; sports_se damalı arka plan = hayalet dikdörtgen). `VEHICLE_FACING_FIXES` doğru arka görünümleri (gerekirse fren-farlı arkalar) çalışma anında ikame ediyor; park hâlinde bayat fren/burun-dalışı düzeltildi; far konisi projeksiyonu düzeltildi. 10-araç frenli-lider deterministik çakışmasız test + park-span geometri testi eklendi. Uzun araç yuva ataması gövde-uzunluğu farkındalıklı (otobüs komşuları bloklar). Erken-aşama geçiş disiplini denendi ve ölçümle REDDEDİLDİ (yol çöküşü; `LEFT_TURN` notu) — S1-3 geçiş transienti açık yol/arsa kararına dosyalandı.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| 2026-08-22 | **AY**     | **Tezgah + karakterler.** Tente (12, 10.85, z 1.75) — bar tezgâh üstünde, saçak servis yönünde; apronda yatan tente bitti. Karakter siluetleri 1.8×'te tutarlı (gövde/kafa/saç/kollar hizalı, ayaklar zeminde); "bacak" dosyaları tam boyda hâlâ kol — NEW_CHARACTER_01–08 regen satırları; UNUSED_RIG_SUBJECTS duruyor.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| 2026-08-22 | **AZ**     | **İnşa görünürlüğü kök nedeni.** `world.layout.placed` render katmanına HİÇ ulaşmıyordu (grep: src/render'da 0 kullanım) + BUILDABLES `ph-prop-*` stem'leri adresliyordu. SimView'e placed/pendingBuilds/layoutRevision; WorldScene statics'e placed dahil; buildable'lar üretim objeleri (saksı→bush-flowering-01, çöp→bin, lamba→lamp); v12 migrasyonu eski kayıtları taşır. Tarayıcı: PLACE→gerçek çöp kutusu sahnede, reload sonrası da duruyor. Commit `29dc5a5`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| 2026-08-22 | **BA**     | **Zamanlı inşaat.** BUY/PLACE → `pendingBuilds` (hash+save v12) → ProgressionSystem sim-zamanı geri sayımı → tamamlanınca seviye+obje+UPGRADE_APPLIED birlikte. Süre `buildDurationMs(cost)` (₡6→7 oyun-dk … tavan 24; aşama evrimlerinin hep altında). Kart «İnşa ediliyor · N dk»; sahnede silüet+amber çubuk. Offline `creditedMs` ile ilerler. Balance gate 5/5 YEŞİL (kalibrasyon bozulmadı). Testler buyBuilt yardımcıyla geçirildi; purchase event testi inşaat boyunca tick'liyor.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| 2026-08-22 | **BB**     | **Tarayıcı doğrulaması.** Senaryolar: satın al→şantiye→açılış (cooler, canlı); PLACE→şantiye→gerçek obje; reload ortasında kalan süre 2500→2200 ms devam; pause 40 tick sabit; 4× tamamlar; gece perdesi 0.6×'te tam; min-zoom'da dünya her yerde; S3'te derin ped+layby; park kareleri doğru arkalar. HUD nakit animasyonu arkaplan-sekme kare boşluklarında ıraksıyordu (₡−2.5e16 boyandı, dünya ₡65'te sağlamdı) → `untrack` + saçma-sıçrama kenetlemesi. Goldenlar konteynerde yenilendi: 24/24, 15 görüntü bilinçli değişti, 4 temsilci göz'den geçti.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| 2026-08-22 | **BC**     | **Pas kapanışı.** Prompt kataloğu 308 (P304–P308 yeni; 17 satır NEEDS REGEN'e döndü — NEW_VEHICLE_01–09, NEW_CHARACTER_01–08, NEW_UI_WORLD_FIX_01–04, NEW_CONSTRUCTION_01); kapsama 22/22, 0 kayıp/çift/yetim; DIRECTION_AUDIT v3. Dokümanlar: UI_SYSTEM §7 kamera yasası, BUILD_CONSTRUCTION_DESIGN, GAMEPLAY_INTERACTION_AUDIT §4, PROGRESSION_DESIGN §8, UI_WORLD_CORRECTION_REPORT. `pnpm verify` + determinizm 61/61 + goldenlar yeşil. DURULDU — kullanıcı incelemesi.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
