...
describe('vehicle motion in the pipeline', () => {
  ...
  it('never produces a negative speed or position', () => {
  ...
  it('only ever moves a vehicle forwards', () => {
  ...
  it('despawns at the end of the lane and returns the slot to the pool', () => {
  ...
  it('reuses slots without leaking them', () => {
  ...
  it('gives every vehicle a distinct entity id', () => {
  ...
  it('marks braking vehicles so the renderer can light them', () => {
  ...
  it('measures how full the road actually is', () => {
    /*
